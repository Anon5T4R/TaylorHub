...
export const CATALOG: CatalogApp[] = [
  ...
  },
  {
    ...
    category: "Sistema",
    name: "LocalBrowser",
    description: "Sites como apps — janelas Firefox com perfil dedicado, uBlock por padrão, extensões",
    kind: "app",
    repo: "Anon5T4R/LocalBrowser",
    assets: { win: "*_x64-setup.exe", linux: "*_amd64.AppImage" },
    silentArgs: ["/S"],
    exe: "LocalBrowser.exe",
    extensions: [],
    accent: "#d97706",
    iconUrl: "https://raw.githubusercontent.com/Anon5T4R/LocalBrowser/main/src-tauri/icons/128x128.png",
  },
  {
    id: "record",
    category: "Mídia",
